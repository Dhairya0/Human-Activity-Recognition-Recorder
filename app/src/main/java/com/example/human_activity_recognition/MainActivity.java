package com.example.human_activity_recognition;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
                AlertDialog dialog = new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", (dialogInterface, i) -> ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, READ_PERMISSION_CODE))
                        .create();
                dialog.show();
                return;
            }
    ...
    private AlertDialog createAddLabelDialog() {
        ...
        return new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Add", (dialogInterface, i) -> {
                    ...
                    if (text.length() == 0) {
                        Toast.makeText(MainActivity.this, "Empty label can't be added", Toast.LENGTH_SHORT).show();
                    } else {
                        saveNewLabel(text);
                        label_spinner.setAdapter(getLabelList());
                        Toast.makeText(MainActivity.this, text + " added as new label", Toast.LENGTH_SHORT).show();
                    }
                })
